    ...
    <div className="space-y-2">
      ...
      >
        ...
        <p className="mt-2 text-sm text-gray-600">
          <span className="font-medium text-green-600">Tap to upload</span> or drag &amp; drop
        </p>
        <p className="text-xs text-gray-400 mt-1">{multiple ? 'Multiple photos supported' : 'One photo'}</p>
        <input
          ref={inputRef}
          type="file"
          accept={accept}
